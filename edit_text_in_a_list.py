...
#                 st.session_state.edited_text[text_index] = st.text_area(
#                     f"Text {j+1}",
...
#     # Create a button to update the original list
#     if st.button("Update Original List"):
#         instructions[:] = st.session_state.edited_text
#         st.success("Original list updated successfully!")
#         print("instructins updated: ", instructions)

#     # Display the updated original list
#     st.subheader("Updated Original List")
